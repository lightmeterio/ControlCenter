...
func (e ResultEntry) IsNone() bool {
	return e.Type == ResultEntryTypeNone
}

func ResultEntryString(v string) ResultEntry {
	return ResultEntry{AsString: v, Type: ResultEntryTypeString}
}

func ResultEntryBlob(v []byte) ResultEntry {
	return ResultEntry{AsBlob: v, Type: ResultEntryTypeBlob}
}

func ResultEntryInt64(v int64) ResultEntry {
	return ResultEntry{AsInt64: v, Type: ResultEntryTypeInt64}
}

func ResultEntryFloat64(v float64) ResultEntry {
	return ResultEntry{AsFloat64: v, Type: ResultEntryTypeFloat64}
}
