...
//line smtpd.gen.go:916
const smtpdReject_start int = 1
const smtpdReject_first_final int = 13
...
//line smtpd.gen.go:936
	{
	cs = smtpdReject_start
	}

//line smtpd.gen.go:941
	{
	if p == pe {
		goto _test_eof
	}
